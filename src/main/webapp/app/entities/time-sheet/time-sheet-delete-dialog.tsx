...
import { getEntity, deleteEntity } from './time-sheet.reducer';
...
export const TimeSheetDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="checkinCheckoutApp.timeSheet.delete.question">
        Are you sure you want to delete Time Sheet {timeSheetEntity.id}?
      </ModalBody>
      <ModalFooter>
