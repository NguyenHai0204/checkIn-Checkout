...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIMESHEET_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIMESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIMESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIMESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIMESHEET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIMESHEET actions', async () => {
      const expectedActions = [
        {
